...
function updateChart(score) {
    ...
    if (score >= 70) {
        chartData.datasets[0].borderColor = '#ff4757';
        chartData.datasets[0].backgroundColor = 'rgba(255, 71, 87, 0.1)';
    } else if (score >= 30) {
        chartData.datasets[0].borderColor = '#ffd700';
        chartData.datasets[0].backgroundColor = 'rgba(255, 215, 0, 0.1)';
    } else {
        chartData.datasets[0].borderColor = '#00f5a0';
        chartData.datasets[0].backgroundColor = 'rgba(0, 245, 160, 0.1)';
    }
